...
## 🛡️ ১.১. কোড শুদ্ধতা ও সোর্স কারেকশন নীতি (Semantic Code & Technical Correctness Policy)

1. **ভুল কোড অন্ধভাবে রেন্ডার করা সম্পূর্ণ নিষিদ্ধ:**
   - ড্রাফট ফাইল `temp/ch-*.md`-এ লেখার সময় যদি অসাবধানতাবশত টাইপো, কপি-পেস্ট ডুপ্লিকেশন বা ভুল কোড থাকে, তা কখনো অন্ধভাবে HTML ও PDF-এ হুবহু বসিয়ে দেওয়া যাবে না।
2. **`✅ Correct` বনাম `❌ Invalid / Incorrect` অডিট:**
   - প্রতিটি সেকশনে যেখানে সঠিক ও ভুলের তুলনা রয়েছে (যেমন: `✅ Correct:` বনাম `❌ Invalid:`), সেখানে অবশ্যই নিশ্চিত করতে হবে:
     - `✅ Correct` বক্সে শতভাগ বৈধ ও স্ট্যান্ডার্ড কোড রয়েছে।
     - `❌ Invalid` বক্সে আসলেই সংশ্লিষ্ট ভুল সিনট্যাক্স বা ভুল লজিকটি প্রদর্শন করা হয়েছে (কপি-পেস্টের কারণে দুটো বক্সে একই কোড থাকা কঠোরভাবে নিষিদ্ধ)।
     - ইনভ্যালিড কোড ব্লকের ভুল টোকেনটিকে লাল রঙ বা ওয়েভি আন্ডারলাইন (`text-decoration: underline wavy #ef4444;`) দিয়ে হাইলাইট করে পাঠককে সুস্পষ্ট শিক্ষা দিতে হবে।
3. **লজিক, সিনট্যাক্স ও আউটপুট ভেরিফিকেশন:**
   - কোডের সাথে তার নিচে উল্লিখিত Console Output বা ব্যাখ্যার ১০০% সংগতি থাকতে হবে।
4. **সোর্স ড্রাফট সংশোধন (Fix Source Markdown First):**
   - ড্রাফটে কোনো টেকনিক্যাল অসঙ্গতি পাওয়া গেলে তা প্রথমে `temp/ch-*.md` ফাইলে সংশোধন করতে হবে, যাতে সোর্স ও প্রডাকশন উভয়ই নিখুঁত থাকে।

---

## 📄 ২. পেজ ১-এর লেআউট ও মাস্টার ব্যানার স্ট্যান্ডার্ড (Master Banner & Page 1 Balance)

- **Master Banner হেডার ডিজাইন:**
  - **JS লোগো ব্যাজ:** জাভাস্ক্রিপ্টের অফিসিয়াল ব্র্যান্ড কালার (হলুদ ব্যাকগ্রাউন্ড `#f7df1e`, বোল্ড কালো টেক্সট `#000000`, `font-family: var(--font-code)`).
  - **চ্যাপ্টার নম্বর ব্যাজ:** `"JavaScript Master Study Documentation"` টাইটেলের ঠিক পাশে বড়, স্পষ্ট ও চোখে পড়ার মতো চ্যাপ্টার ব্যাজ (যেমন: `<span class="chapter-badge">Chapter 26</span>`, হলুদ ব্যাকগ্রাউন্ড `#f7df1e`, গাঢ় কালো টেক্সট `#000000`, `font-size: 13.5px`, `font-weight: 800` ও সূক্ষ্ম শ্যাডো)। এর ফলে চ্যাপ্টার নম্বর তাৎক্ষণিকভাবে পাঠকের নজরে আসে।
  - **সাবটাইটেল:** চ্যাপ্টারের মূল বিষয়বস্তুর অল-ক্যাপস সাবটাইটেল।
  - **৪-কলাম মেটাডাটা গ্রিড:** Total Modules, Curriculum Part, Core Mechanics, Reference Standard.
- **পেজ ১-এ ব্যালান্স:**
  - `Master Banner`
  - `Opening Statement Card` (ভূমিকা ও কম্প্যাক্ট রোডম্যাপ গ্রিড)
  - `Part 01 Banner`
  - `Section 1 Card` (প্রথম টপিকের পূর্ণাঙ্গ কার্ড)
- এই উপাদানগুলো পেজ ১-এ সম্পূর্ণ অক্ষত অবস্থায় চমৎকারভাবে ফিট হবে এবং সেকশন ২ পরিষ্কারভাবে পেজ ২ থেকে শুরু হবে।
